                                        ...
                                        <li>
                                            ...
                                            <ul class="clearfix sub-menu">
                                                <li class="clearfix">
                                                    ...
                                                    <figure>
                                                        <a href="#"><img src="<?=_WEB_PATH?>/views/images/product7.png" alt=""/></a>
                                                    </figure>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <li>
                                            ...
                                            <ul class="clearfix sub-menu menu-three">
                                                <li class="clearfix">
                                                    ...
                                                    <figure>
                                                        <a href="#"><img src="<?=_WEB_PATH?>/views/images/menu-img.png" alt=""/></a>
                                                    </figure>
                                                    <div class="links">
                                                        <h3>Furnitures</h3>
                                                        <p>
                                            ...
                                            <ul class="clearfix sub-menu menu-four">
                                                <li class="clearfix">
                                                    ...
                                                    <div class="our-product">
                                                        ...
                                                        <div class="clearfix">
                                                            <a href="#"><img src="<?=_WEB_PATH?>/views/images/shopping-img.png" alt=""/></a>
                                                            <h4>Brown Wood Chair</h4>
                                                            <span>$244.00</span>
                                                        </div>

                                                        <div class="clearfix">
                                                            <a href="#"><img src="<?=_WEB_PATH?>/views/images/shopping-img3.png" alt=""/></a>
                                                            <h4>Brown Wood Chair</h4>
                                                            <span>$244.00</span>
                                                        </div>

                                                        <div class="clearfix">
                                                            <a href="#"><img src="<?=_WEB_PATH?>/views/images/shopping-img5.png" alt=""/></a>
                                                            <h4>Brown Wood Chair</h4>
                                                            <span>$244.00</span>
                                                        </div>
