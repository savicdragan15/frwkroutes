        ...
        <div class="col-lg-8 col-md-10 col-sm-12 col-xs-12">
            <div class="form-group">
                <form action="" method="POST" id="unos_proizvoda">
                    ...
                    <br>
                    <div class="form-group">
                    <label for="kategorija"><i class="fa fa-file-text-o"></i> Kategorija</label>
                      <select class="form-control" id="kategorija">
                          <option value="-1">Izaberite kategoriju</option>
                       <?php foreach ($kategorije as $kategorija){?>
                          <option value="<?=$kategorija->id?>"> <?= $kategorija->kategorija_naziv?></option>
                       <?php } ?>
                      </select>
                    </div>
                     <div class="form-group">
                    <label for="podkategorija"><i class="fa fa-file-text-o"></i> Podkategorija</label>
