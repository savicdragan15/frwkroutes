<form action="" method="post" id="poruci">
            ...
            <div class="table-responsive">
                    <table class="table table-bordered tbl-checkout">
                                ...
                                <tr>
                                    <td>Adresa</td>
                                    <td colspan="3">
                                        <textarea name="adresa" id="adresa" class="form-control"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Grad</td>
                                    ...
                                    <td>
                                        <input type="text" name="postanski_broj" id="postanski_broj" class="form-control" />
                                    </td>
                                </tr>
<!--                                <tr>
                                    <td>Country</td>
      ...
      rules: {
        ...
        submitHandler: function() {
            var data = {
                ...
                "grad":$('#grad').val().trim(),
                "postanski_broj":$('#postanski_broj').val().trim(),
                "komentar":$('#komentar').val().trim()
            };
           $.ajax({
            url: "<?=_WEB_PATH?>korpa/poruci",
            type: "POST",
            dataType: 'json',
            data: data,
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            ...
            success: function(response){
              ...
              content +="<tr>";
                 content +="<td align='right' colspan='2'>Poštarina</td>";
                 content +="<td colspan='2' class='postarina'><b>"+postarina+" RSD</b></td>";
               content +="</tr>";
              content +="<tr>";
              var ukupno = response.ukupno + postarina;
                content +="<td colspan='2' align='right'>Ukupno</td>";
                   content +=" <td class='total' colspan='2'><b>"+ukupno+" RSD </b>";
                   content +="</td>";
                content +="</tr>";
              }else{
                 content +="<tr>";
     ...
     $('body').on('click', '.remove_cart', function(e){
        ...
        $.ajax({
            ...
            success: function(response){
              ...
              $('.total').find('b').text(response.ukupna_cena + 250+' RSD');
